    ...
    return (
        <div className="container m-auto flex flex-col gap-5 md:gap-10 justify-center items-start">
            <div className="flex flex-col gap-4">
                ...
                <h2 className="text-xl md:text-2xl leading-[44px] font-semibold mb-2 text-[36px]">Mock Test Pool</h2>
                <p className="text-black-500 text-sm md:text-xl">Lever System has a wide range of standard test pool</p>
